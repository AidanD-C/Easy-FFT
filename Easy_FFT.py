...
def FFT_2D(function: Callable[[NDArray, NDArray], NDArray], box_width: float, dx: int) -> tuple[NDArray, NDArray, NDArray]:
    """
...
def IFFT_2D(function: Callable[[NDArray, NDArray], NDArray], box_width: float, dk: int) -> tuple[NDArray, NDArray, NDArray]:
    """
    Docstring TBD
    """
